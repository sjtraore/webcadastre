...
/**
 * Home object for domain model class Property.
 * @see .Property
...
public class PropertyHome {
	...
	public void persist(Property transientInstance) {
		log.debug("persisting Property instance");
		try {
	...
	public Property merge(Property detachedInstance) {
		...
		try {
			Property result = (Property) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Property findById(int id) {
		...
		try {
			Property instance = (Property) sessionFactory.getCurrentSession().get("Property", id);
			if (instance == null) {
	...
	public List findByExample(Property instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Property").add(Example.create(instance))
					.list();
